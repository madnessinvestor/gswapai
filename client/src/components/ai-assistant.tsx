...
export default function AISwapAssistant({ onSwapAction, tokens, balances, walletConnected }: AISwapAssistantProps) {
        ...
        {walletConnected && (
          <div className="flex justify-between items-center bg-[#2d1b4d]/40 rounded-xl px-4 py-2 border border-primary/10 text-[11px] font-medium text-muted-foreground">
            <div className="flex items-center gap-2">
              ...
              <span>USDC: <span className="text-foreground">{balances.USDC}</span></span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-yellow-400 shadow-[0_0_4px_rgba(250,204,21,0.5)]" />
              <span>EURC: <span className="text-foreground">{balances.EURC}</span></span>
            </div>
          </div>
        )}
